...
list_ep = settings.END_POINT_LIST
...
@router.get(f'/{list_ep}', response_model = list_work_schemas.ListWorkResponse, status_code = status.HTTP_200_OK)
...
@router.post('/{board_id}'f'/{list_ep}', response_model = list_work_schemas.ListWork, status_code = status.HTTP_201_CREATED)
